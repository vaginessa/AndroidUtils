...
fun Fragment.stringListExtra(key: String? = null, defaultValue: () -> List<String> = { emptyList() }): ReadWriteProperty<Fragment, List<String>> = object : ReadWriteProperty<Fragment, List<String>> {
...
fun Fragment.stringArrayExtra(key: String? = null, defaultValue: () -> Array<String> = { emptyArray() }): ReadWriteProperty<Fragment, Array<String>> = object : ReadWriteProperty<Fragment, Array<String>> {
...
fun <T : Parcelable> Fragment.parcelableListExtra(key: String? = null, defaultValue: () -> List<T> = { emptyList() }): ReadWriteProperty<Fragment, List<T>> = object : ReadWriteProperty<Fragment, List<T>> {
...
inline fun <reified T : Parcelable> Fragment.parcelableArrayExtra(key: String? = null, crossinline defaultValue: () -> Array<T> = { emptyArray() }): ReadWriteProperty<Fragment, Array<T>> = object : ReadWriteProperty<Fragment, Array<T>> {
...
fun Fragment.shortArrayExtra(key: String? = null, defaultValue: () -> ShortArray = { ShortArray(0) }): ReadWriteProperty<Fragment, ShortArray> = object : ReadWriteProperty<Fragment, ShortArray> {
...
fun Fragment.longArrayExtra(key: String? = null, defaultValue: () -> LongArray = { LongArray(0) }): ReadWriteProperty<Fragment, LongArray> = object : ReadWriteProperty<Fragment, LongArray> {
...
fun Fragment.floatArrayExtra(key: String? = null, defaultValue: () -> FloatArray = { FloatArray(0) }): ReadWriteProperty<Fragment, FloatArray> = object : ReadWriteProperty<Fragment, FloatArray> {
...
fun Fragment.doubleArrayExtra(key: String? = null, defaultValue: () -> DoubleArray = { DoubleArray(0) }): ReadWriteProperty<Fragment, DoubleArray> = object : ReadWriteProperty<Fragment, DoubleArray> {
...
fun Fragment.charSequenceListExtra(key: String? = null, defaultValue: () -> List<CharSequence> = { emptyList() }): ReadWriteProperty<Fragment, List<CharSequence>> = object : ReadWriteProperty<Fragment, List<CharSequence>> {
...
fun Fragment.charSequenceArrayExtra(key: String? = null, defaultValue: () -> Array<CharSequence> = { emptyArray() }): ReadWriteProperty<Fragment, Array<CharSequence>> = object : ReadWriteProperty<Fragment, Array<CharSequence>> {
...
fun Fragment.charArrayExtra(key: String? = null, defaultValue: () -> CharArray = { CharArray(0) }): ReadWriteProperty<Fragment, CharArray> = object : ReadWriteProperty<Fragment, CharArray> {
...
fun Fragment.byteArrayExtra(key: String? = null, defaultValue: () -> ByteArray = { ByteArray(0) }): ReadWriteProperty<Fragment, ByteArray> = object : ReadWriteProperty<Fragment, ByteArray> {
...
fun Fragment.bundleExtra(key: String? = null, defaultValue: () -> Bundle = { Bundle() }): ReadWriteProperty<Fragment, Bundle> = object : ReadWriteProperty<Fragment, Bundle> {
...
fun Fragment.booleanArrayExtra(key: String? = null, defaultValue: () -> BooleanArray = { BooleanArray(0) }): ReadWriteProperty<Fragment, BooleanArray> = object : ReadWriteProperty<Fragment, BooleanArray> {
